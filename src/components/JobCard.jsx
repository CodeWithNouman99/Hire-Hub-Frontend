        ...
        {filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {filtered.map((job) => {
              ...
              const postedLabel =
                job.posted === 1 ? "Today" : `${job.posted}d ago`;
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center border border-gray-200 flex-shrink-0 overflow-hidden">
                        {job.employer_logo ? (
                          <img
  src={job.logo}
  alt={job.company}
...
/>
                    ...
                    <span
                      className={`text-[11px] font-medium px-2.5 py-1 rounded-full whitespace-nowrap ${TYPE_STYLES[job.type]}`}
                    >
                      {job.type}
                    </span>
                  </div>
